# Generated by Django 2.2.8 on 2020-07-13 14:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('S', 'Shirt'), ('B', 'Bottom'), ('SW', 'Sport wear'), ('OW', 'Outerwear'), ('A', 'Accessories')], max_length=2)),
                ('label', models.CharField(blank=True, choices=[('P', 'primary'), ('S', 'secondary'), ('W', 'warning'), ('D', 'danger')], max_length=1, null=True)),
                ('label_name', models.CharField(blank=True, choices=[('N', 'NEW'), ('H', 'HOT'), ('F', 'FREE SHIPPING')], max_length=1, null=True)),
